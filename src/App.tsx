...
export default function App() {
  // Control de pantallas del chat: 'splash', 'chat', 'call', 'video'
  ...
  // Temporizador para simular la pantalla de carga neón por 3 segundos
  useEffect(() => {
  ...
  // ==========================================
  // PANTALLA 1: SPLASH SCREEN (MARCA NEÓN)
  // ==========================================
  if (screen === 'splash') {
    return (
  ...
  // ==========================================
  // PANTALLA 2: LLAMADA DE VOZ O VIDEO INTERNACIONAL
  // ==========================================
    ...
    return (
      <div className="flex flex-col items-center justify-between min-h-screen bg-slate-950 text-white p-8 font-sans">
        ...
        <div className="flex items-center justify-center gap-6 mb-12">
          ...
          {/* BOTÓN ROJO PARA FINALIZAR LLAMADA (Regresa a la pantalla de chat limpio) */}
  ...
  // ==========================================
  // PANTALLA 3: INTERFAZ PRINCIPAL DE CHAT ESTILO WHATSAPP (PANTALLA LIMPIA)
  // ==========================================
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 font-sans antialiased text-slate-200 selection:bg-blue-500/30">
      ...
      {/* Header Principal Estilo WhatsApp con los nombres solicitados */}
      <header className="sticky top-0 z-40 bg-slate-900/90 backdrop-blur-md px-4 py-3 flex items-center justify-between border-b border-slate-800 shadow-md">
        ...
        {/* BOTONES ACTIVADORES DE LLAMADA Y VIDEOCLAMADA */}
        <div className="flex items-center gap-2">
          ...
          <button type="button" onClick={() => setScreen('video')} className="p-2 text-slate-300 hover:text-blue-400 hover:bg-slate-800 rounded-full transition-all" title="Video Llamada">
